"""
Code Agent Logging Configuration

Structured logging system with JSON formatting, performance metrics,
and configurable log levels for comprehensive observability.
...
class JSONFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        # Add extra fields safely (avoid direct attribute access that static checkers flag)
...
class HumanFormatter(logging.Formatter):
    ...
    Outputs logs in a clean, readable format for console viewing.
    """
...
class PerformanceMetrics:
    ...
    Tracks execution time, token usage, and operation counts.
    """
...
class StructuredLogger:
    ...
    Provides comprehensive logging with automatic sanitization,
    performance metrics, and flexible output formats.
    """
